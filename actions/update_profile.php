...
if ($user['role'] === 'trainer') {
    ...
    $trainer_errors = [];
    $allowed_specialties = ['strength','cardio','yoga','crossfit','pilates','martial_arts','nutrition'];
    if ($specialty && !in_array($specialty, $allowed_specialties)) {
        $trainer_errors[] = 'Invalid specialty selected.';
    }
